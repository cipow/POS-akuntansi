...
class Laporan extends Controller {
  ...
  public function laporanBulanan(Request $req) {
    ...
    $depresiasi = [
      'bangunan' => (int) $this->user->asset()->belumKadaluarsa()->kategori('bangunan')->sum('nilai_penyusutan'),
      'kendaraan' => (int) $this->user->asset()->belumKadaluarsa()->kategori('kendaraan')->sum('nilai_penyusutan'),
      'peralatan' => (int) $this->user->asset()->belumKadaluarsa()->kategori('peralatan')->sum('nilai_penyusutan')
    ];
